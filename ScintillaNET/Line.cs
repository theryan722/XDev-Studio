...
namespace ScintillaNET
{
    ...
    public class Line
    {
        ...
        /// </summary>
        /// <param name="markerMask">An unsigned 32-bit value with each bit corresponding to one of the 32 zero-based <see cref="Margin" /> indexes to add.</param>
        ...
        /// </summary>
        /// <returns>An unsigned 32-bit value with each bit corresponding to one of the 32 zero-based <see cref="Margin" /> indexes.</returns>
