...
#Region "Methods"
    ...
    Private Sub GetChannelInfo()
        ...
        Catch ex As Exception
            ...
            MetroFramework.MetroMessageBox.Show(frmManager, "There was an error attempting to get the feed info.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
        End Try
    End Sub
